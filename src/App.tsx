          ...
          <div className="grid gap-0 lg:grid-cols-[1fr_25rem]">
            ...
            <aside id="data-import" className="scroll-mt-24 border-t border-white/10 bg-gradient-to-br from-slate-900 via-slate-950 to-emerald-950/40 p-6 lg:border-l lg:border-t-0">
              <div className="rounded-3xl border border-emerald-300/20 bg-emerald-300/10 p-5 shadow-xl shadow-emerald-950/30">
                ...
                <p className="mt-2 rounded-2xl border border-amber-300/20 bg-amber-400/10 px-3 py-2 text-xs leading-5 text-amber-100"><span className="font-semibold">⚠️ US Market Support Only:</span> Optimized exclusively for US stocks &amp; ETFs (USD). Non-US assets in local currencies (EU/JP/KR) are not supported and will result in inaccurate PnL tracking.</p>
